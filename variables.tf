...
variable "nlb_name" {
  type        = string
  description = "nlb_tagname"
}

variable "nlb_internal" {
  type        = bool
  description = "nlb_internal"
}

variable "load_balancer_type_nlb" {
  type        = string
  description = "load_balancer_type_nlb"
}

variable "environment_nlb" {
  type        = string
  description = "environment_nlb"
}

variable "nlb_tagname" {
  type        = string
  description = "nlb_tagname"
}

variable "alb_tg_name_80" {
  type        = string
  description = "alb_tg_name_80"
}

variable "alb_tg_name_443" {
  type        = string
  description = "alb_tg_name_443"
}

variable "alb_tg_name_port" {
  type        = string
  description = "alb_tg_name_port"
}

variable "port_alb_tg" {
  type        = number
  description = "port_alb_tg"
}

variable "protocol_alb_tg_port" {
  type        = string
  description = "protocl_alb_tg_port"
}

variable "name_prefix_asg_lt" {
  type        = string
  description = "name_prefix_asg_lt"
}

variable "image_id_asg_lt" {
  type        = string
  description = "image_id_asg_lt"
}

variable "instance_type_asg_lt" {
  type        = string
  description = "instance_type_asg_lt"
}
...
variable "max_size_asg" {
  type        = number
  description = "max_size_asg"
}

variable "min_size_asg" {
  type        = number
  description = "min_size_asg"
}

variable "health_check_grace_period_asg" {
  type        = number
  description = "health_check_grace_period_asg"
}

variable "health_check_type_asg" {
  type        = string
  description = "health_check_type_asg"
}

variable "desired_capacity_asg" {
  type        = number
  description = "desired_capacity_asg"
}
